...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', type=str, default='data/custom/image')
    parser.add_argument('--model_def', type=str, default='config/custom.cfg')
    parser.add_argument('--weights_path', type=str, default='my/yolov3.pth')
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections), 1):
        if opt.print_progress: print('{0:>4} images: "{1}"'.format(img_i, path))
        # Create plot
