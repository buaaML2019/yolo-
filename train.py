...
def evaluate(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size, device):
    ...
    return precision, recall, AP, f1, ap_class,pred_scores,pred_labels
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', type=str, default='checkpoints/yolov3.pth')
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        #     tc.save(model.state_dict(), f'my/yolov3_ckpt_{epoch}.pth')
        tc.save(model.state_dict(), f'my/yolov3_ckpt_{epoch}.pth')
